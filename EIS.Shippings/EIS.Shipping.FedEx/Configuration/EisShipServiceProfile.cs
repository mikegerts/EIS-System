...
{
    public class EisShipServiceProfile : Profile
    {
        public EisShipServiceProfile()
        {
            Mapper.Initialize(cfg =>
            {
                ...
                cfg.CreateMap<EisCompletedShipmentDetail, CompletedShipmentDetail>();
                ...
                cfg.CreateMap<ProcessShipmentReply, EisReply>();
                ...
                cfg.CreateMap<CompletedShipmentDetail, EisCompletedShipmentDetail>();
                cfg.CreateMap<VersionId, EisVersionId>();
            });
        }

        public override string ProfileName
        {
            get { return "EisShipServiceProfile"; }
        }
    }
}
