...
namespace BigCommerce4Net.Api.ResourceClients
{
        ...
        IChildResourceCount
    {
        ...
        // manually added by Al Rosal 02/28/2017
        public IClientResponse<bool> Delete(int productid, int customfieldid)
        {
            string resourceEndpoint = string.Format("/products/{0}/custom_fields/{1}", productid, customfieldid);
