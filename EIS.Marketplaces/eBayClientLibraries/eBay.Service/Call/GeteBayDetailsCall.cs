...
namespace eBay.Service.Call
{
	...
	public class GeteBayDetailsCall : ApiCall
	{
		...
		/// <b>DetailNameCodeType</b>) are the same name as fields returned by the
		/// response. See the documentation for the <b>GeteBayDetails</b> response to
		/// better understand the <b>DetailName</b> options.
		/// </param>
		///
