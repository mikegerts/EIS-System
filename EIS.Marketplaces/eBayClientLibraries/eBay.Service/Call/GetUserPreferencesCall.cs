...
namespace eBay.Service.Call
{
	...
	public class GetUserPreferencesCall : ApiCall
	{
		...
		/// If included and set to <code>true</code>, the seller's preference for receiving contact
		/// information for unsuccessful bidders is returned in the response.
		/// </param>
		///
		/// <param name="ShowCombinedPaymentPreferences">
		/// If included and set to <code>true</code>, the seller's combined payment preferences are
		...
		/// If included and set to <code>true</code>, the seller's payment preferences are returned
		/// in the response.
		/// </param>
		///
		/// <param name="ShowEndOfAuctionEmailPreferences">
		/// If included and set to <code>true</code>, the seller's preferences for the end-of-auction
		...
		/// If included and set to <code>true</code>, the seller's favorite item preferences are
		...
		/// If included and set to <code>true</code>, the seller's preference for sending an email to
		/// the buyer with the shipping tracking number is returned in the response.
		/// </param>
		///
		/// <param name="ShowRequiredShipPhoneNumberPreference">
		/// If included and set to <code>true</code>, the seller's preference for requiring that the
		...
		/// If included and set to <code>true</code>, all of the seller's excluded shipping locations
		...
		/// If included and set to <code>true</code>, the seller's Unpaid Item Assistant preferences
		...
		/// If included and set to <code>true</code>, the seller's preference for sending a purchase
		/// reminder email to buyers is returned in the response.
		/// </param>
		///
		/// <param name="ShowUnpaidItemAssistanceExclusionList">
		/// If included and set to <code>true</code>, the list of eBay user IDs on the Unpaid Item
		...
		/// If this flag is included and set to <code>true</code>, the seller's Business Policies profile information is
		...
		/// If included and set to <code>true</code>, the seller's same day handling cut off time is returned in <strong>DispatchCutoffTimePreference.CutoffTime</strong>.
		/// </param>
		///
		...
		/// If included and set to <code>true</code>, the <strong>PickupDropoffSellerPreference</strong> field is returned. A returned value of <code>true</code> indicates that the seller's new listings will enable the Click and Collect feature by default.
		/// <br/><br/>
		...
		/// If included and set to <code>true</code>, the seller's preferences related to the Out-of-Stock feature will be returned. This feature is set using the
