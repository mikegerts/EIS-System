...
namespace eBay.Service.Call
{
	...
	public class GetSellerListCall : ApiCall
	{
		...
		/// Specifies the subset of item and user fields to return. See <b>GetSellerList</b>
		...
		/// in the <b>GetSellerList</b> request).
		/// 
		/// <b>SKUArray</b> can be used to retrieve items listed by the user
		/// identified in <b>AuthToken</b> or in <b>UserID</b>.
		/// 
		...
		/// Specifies whether to include <b>WatchCount</b> in Item nodes returned.
		...
		/// If true, the <b>Variations</b> node is returned for all multi-variation
