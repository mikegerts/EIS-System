...
namespace eBay.Service.Call
{
	...
	public class ReviseMyMessagesCall : ApiCall
	{
		...
		/// Contains a list of up to 10 <b>MessageIDs</b>
		...
		///
		/// <param name="Read">
		/// Changes the read states of all messages specified in a request. At least one of the <b>Read</b>, <b>Flagged</b>, or <b>FolderID</b> fields must be specified in the request. Messages in the Sent box cannot be moved, marked as read, or flagged. 
